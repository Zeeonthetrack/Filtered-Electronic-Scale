...
{
		uint8_t OPx_Readoffset0,OPx_Readoffset1,OPx_Readoffset2,OPx_Readoffset3,OPx_Readoffset4,OPx_Readoffset5;
	  ...
	  OPx_Readoffset3 =  *((uint8_t *)0X08C00000+0x483);
		OPx_Readoffset4 =  *((uint8_t *)0X08C00000+0x484);
		OPx_Readoffset5 =  *((uint8_t *)0X08C00000+0x485);
